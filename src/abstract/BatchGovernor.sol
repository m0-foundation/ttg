...
abstract contract BatchGovernor is IBatchGovernor, ERC712 {
    ...
    function castVoteBySig(
        ...
        _revertItInvalidSignature(voter_, _getBallotDigest(proposalId_, support_), signature_);
    ...
    function castVotesBySig(
        ...
        _revertItInvalidSignature(voter_, _getBallotsDigest(proposalIds_, supports_), signature_);
