...
export interface EpochBasedVoteTokenAbiInterface extends utils.Interface {
  functions: {
...
export interface EpochBasedVoteTokenAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EpochBasedVoteTokenAbiInterface;
