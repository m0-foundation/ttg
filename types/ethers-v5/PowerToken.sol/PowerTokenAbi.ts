...
export interface PowerTokenAbiInterface extends utils.Interface {
  functions: {
...
export interface PowerTokenAbi extends BaseContract {
  ...
  functions: {
    ...
    activeEpochs(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { activeEpochs_: BigNumber }>;
    ...
    amountToAuction(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { amountToAuction_: BigNumber }>;
    ...
    bootstrapEpoch(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { bootstrapEpoch_: BigNumber }>;
    ...
    bootstrapToken(
      overrides?: CallOverrides
    ): Promise<[string] & { bootstrapToken_: string }>;
    ...
    getCost(
      amount_: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { cost_: BigNumber }>;
    ...
    governor(
      overrides?: CallOverrides
    ): Promise<[string] & { governor_: string }>;
    ...
    isActiveEpoch(
      epoch_: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[boolean] & { isActiveEpoch_: boolean }>;
  ...
  getCost(amount_: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
