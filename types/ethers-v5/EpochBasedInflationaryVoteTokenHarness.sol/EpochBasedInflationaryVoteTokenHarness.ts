...
export interface EpochBasedInflationaryVoteTokenHarnessInterface
  ...
  functions: {
    ...
    "delegateeInflationIndexOf(address,uint256)": FunctionFragment;
    ...
    "inflationIndexOf(address,uint256)": FunctionFragment;
...
export interface EpochBasedInflationaryVoteTokenHarness extends BaseContract {
  ...
  functions: {
    ...
    delegateeInflationIndexOf(
      ...
      index_: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { inflationIndex_: BigNumber }>;
    ...
    hasParticipatedAt(
      ...
      epoch_: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[boolean] & { participated_: boolean }>;
    ...
    participationInflation(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { participationInflation_: BigNumber }>;
