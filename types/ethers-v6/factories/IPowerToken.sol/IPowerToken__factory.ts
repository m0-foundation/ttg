...
export class IPowerToken__factory {
  ...
  static createInterface(): IPowerTokenInterface {
    return new Interface(_abi) as IPowerTokenInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IPowerToken {
    return new Contract(address, _abi, runner) as unknown as IPowerToken;
  }
}
