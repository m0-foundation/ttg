...
export class MockPowerToken__factory extends ContractFactory {
  ...
  override connect(runner: ContractRunner | null): MockPowerToken__factory {
    return super.connect(runner) as MockPowerToken__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): MockPowerTokenInterface {
    return new Interface(_abi) as MockPowerTokenInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): MockPowerToken {
    return new Contract(address, _abi, runner) as unknown as MockPowerToken;
  }
}
