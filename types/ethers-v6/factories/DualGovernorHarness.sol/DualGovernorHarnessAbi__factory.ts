...
import type {
  DualGovernorHarnessAbi,
  DualGovernorHarnessAbiInterface,
} from "../../DualGovernorHarness.sol/DualGovernorHarnessAbi";
...
export class DualGovernorHarnessAbi__factory {
  static readonly abi = _abi;
  static createInterface(): DualGovernorHarnessAbiInterface {
    return new Interface(_abi) as DualGovernorHarnessAbiInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as DualGovernorHarnessAbi;
  }
}
