...
export class EpochBasedVoteToken__factory extends ContractFactory {
  ...
  ): EpochBasedVoteToken__factory {
    return super.connect(runner) as EpochBasedVoteToken__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): EpochBasedVoteTokenInterface {
    return new Interface(_abi) as EpochBasedVoteTokenInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as EpochBasedVoteToken;
  }
}
