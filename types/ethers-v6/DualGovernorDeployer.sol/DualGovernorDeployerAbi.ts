...
export interface DualGovernorDeployerAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "deploy"
...
export interface DualGovernorDeployerAbi extends BaseContract {
  connect(runner?: ContractRunner | null): DualGovernorDeployerAbi;
  waitForDeployment(): Promise<this>;

  interface: DualGovernorDeployerAbiInterface;
