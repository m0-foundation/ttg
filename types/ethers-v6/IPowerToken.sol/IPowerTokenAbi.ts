...
export interface IPowerTokenAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "CLOCK_MODE()"
...
export interface IPowerTokenAbi extends BaseContract {
  connect(runner?: ContractRunner | null): IPowerTokenAbi;
  ...
  buy: TypedContractMethod<
    [amount: BigNumberish, destination: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getCost: TypedContractMethod<[amount: BigNumberish], [bigint], "view">;
  ...
  hasParticipatedAt: TypedContractMethod<
    [delegatee: AddressLike, epoch: BigNumberish],
    [boolean],
    "view"
  >;
  ...
  isActiveEpoch: TypedContractMethod<[epoch: BigNumberish], [boolean], "view">;
  ...
  ): TypedContractMethod<[epoch: BigNumberish], [boolean], "view">;
  getFunction(
