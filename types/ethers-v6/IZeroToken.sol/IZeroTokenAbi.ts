...
export interface IZeroTokenAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "CLOCK_MODE()"
...
export interface IZeroTokenAbi extends BaseContract {
  connect(runner?: ContractRunner | null): IZeroTokenAbi;
  waitForDeployment(): Promise<this>;

  interface: IZeroTokenAbiInterface;
