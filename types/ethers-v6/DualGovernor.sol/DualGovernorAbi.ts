...
export interface DualGovernorAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOTS_TYPEHASH"
      | "BALLOTS_TYPEHASH()"
...
export interface DualGovernorAbi extends BaseContract {
  connect(runner?: ContractRunner | null): DualGovernorAbi;
  waitForDeployment(): Promise<this>;

  interface: DualGovernorAbiInterface;
