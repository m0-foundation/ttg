...
export interface IPowerTokenDeployerAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "deploy"
...
export interface IPowerTokenDeployerAbi extends BaseContract {
  connect(runner?: ContractRunner | null): IPowerTokenDeployerAbi;
  waitForDeployment(): Promise<this>;

  interface: IPowerTokenDeployerAbiInterface;
