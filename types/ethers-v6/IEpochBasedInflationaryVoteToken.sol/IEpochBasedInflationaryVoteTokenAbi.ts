...
export interface IEpochBasedInflationaryVoteTokenAbiInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
...
export interface IEpochBasedInflationaryVoteTokenAbi extends BaseContract {
  connect(runner?: ContractRunner | null): IEpochBasedInflationaryVoteTokenAbi;
  waitForDeployment(): Promise<this>;

  interface: IEpochBasedInflationaryVoteTokenAbiInterface;
