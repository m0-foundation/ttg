...
export interface IEpochBasedInflationaryVoteTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "CLOCK_MODE()"
...
export interface IEpochBasedInflationaryVoteToken extends BaseContract {
  connect(runner?: ContractRunner | null): IEpochBasedInflationaryVoteToken;
  waitForDeployment(): Promise<this>;

  interface: IEpochBasedInflationaryVoteTokenInterface;
