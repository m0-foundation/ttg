...
export interface DualGovernorHarnessInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOTS_TYPEHASH"
      | "BALLOTS_TYPEHASH()"
...
export interface DualGovernorHarness extends BaseContract {
  connect(runner?: ContractRunner | null): DualGovernorHarness;
  waitForDeployment(): Promise<this>;

  interface: DualGovernorHarnessInterface;
  ...
  setNumberOfProposals: TypedContractMethod<
    [epoch_: BigNumberish, numberOfProposals_: BigNumberish],
    [void],
    "nonpayable"
  >;

  "setNumberOfProposals(uint256,uint256)": TypedContractMethod<
    [epoch_: BigNumberish, numberOfProposals_: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  "setProposal(uint256,address,uint256,uint256,bool,uint8)": TypedContractMethod<
    [
      proposalId_: BigNumberish,
      proposer_: AddressLike,
      voteStart_: BigNumberish,
  ...
  getFunction(
    nameOrSignature: "setNumberOfProposals"
  ): TypedContractMethod<
    [epoch_: BigNumberish, numberOfProposals_: BigNumberish],
    [void],
    "nonpayable"
  >;
  getFunction(
    nameOrSignature: "setNumberOfProposals(uint256,uint256)"
  ): TypedContractMethod<
    [epoch_: BigNumberish, numberOfProposals_: BigNumberish],
    [void],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "setProposal(uint256,address,uint256,uint256,bool,uint8)"
  ): TypedContractMethod<
    [
      proposalId_: BigNumberish,
      proposer_: AddressLike,
