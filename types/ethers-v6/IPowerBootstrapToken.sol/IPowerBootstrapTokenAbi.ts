...
export interface IPowerBootstrapTokenAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOfAt"
...
export interface IPowerBootstrapTokenAbi extends BaseContract {
  connect(runner?: ContractRunner | null): IPowerBootstrapTokenAbi;
  waitForDeployment(): Promise<this>;

  interface: IPowerBootstrapTokenAbiInterface;
