...
export interface IEpochBasedVoteTokenAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "CLOCK_MODE()"
...
export interface IEpochBasedVoteTokenAbi extends BaseContract {
  connect(runner?: ContractRunner | null): IEpochBasedVoteTokenAbi;
  waitForDeployment(): Promise<this>;

  interface: IEpochBasedVoteTokenAbiInterface;
