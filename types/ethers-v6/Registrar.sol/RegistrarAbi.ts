...
export interface RegistrarAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addToList"
...
export interface RegistrarAbi extends BaseContract {
  connect(runner?: ContractRunner | null): RegistrarAbi;
  ...
  "get(bytes32)": TypedContractMethod<[key_: BytesLike], [string], "view">;
  ...
  "listContains(bytes32,address[])": TypedContractMethod<
    [list_: BytesLike, accounts_: AddressLike[]],
    [boolean],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "get(bytes32[])"
  ): TypedContractMethod<[keys_: BytesLike[]], [string[]], "view">;
  getFunction(
