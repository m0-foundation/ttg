...
export interface IGovernorBySigInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "BALLOT_TYPEHASH()"
...
export interface IGovernorBySig extends BaseContract {
  connect(runner?: ContractRunner | null): IGovernorBySig;
  waitForDeployment(): Promise<this>;

  interface: IGovernorBySigInterface;
