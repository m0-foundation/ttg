...
export interface IERC20LikeAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
...
export interface IERC20LikeAbi extends BaseContract {
  connect(runner?: ContractRunner | null): IERC20LikeAbi;
  waitForDeployment(): Promise<this>;

  interface: IERC20LikeAbiInterface;
