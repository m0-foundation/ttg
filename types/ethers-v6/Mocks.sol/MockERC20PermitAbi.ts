...
export interface MockERC20PermitAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "DOMAIN_SEPARATOR()"
...
export interface MockERC20PermitAbi extends BaseContract {
  connect(runner?: ContractRunner | null): MockERC20PermitAbi;
  waitForDeployment(): Promise<this>;

  interface: MockERC20PermitAbiInterface;
