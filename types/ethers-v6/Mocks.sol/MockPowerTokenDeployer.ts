...
export interface MockPowerTokenDeployerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "deploy"
...
export interface MockPowerTokenDeployer extends BaseContract {
  connect(runner?: ContractRunner | null): MockPowerTokenDeployer;
  waitForDeployment(): Promise<this>;

  interface: MockPowerTokenDeployerInterface;
