...
export interface MockCashTokenAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface MockCashTokenAbi extends BaseContract {
  connect(runner?: ContractRunner | null): MockCashTokenAbi;
  waitForDeployment(): Promise<this>;

  interface: MockCashTokenAbiInterface;
