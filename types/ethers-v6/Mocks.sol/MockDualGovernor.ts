...
export interface MockDualGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "cashToken"
      | "cashToken()"
...
export interface MockDualGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): MockDualGovernor;
  waitForDeployment(): Promise<this>;

  interface: MockDualGovernorInterface;
