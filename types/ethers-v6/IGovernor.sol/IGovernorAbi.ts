...
export interface IGovernorAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "CLOCK_MODE()"
...
export interface IGovernorAbi extends BaseContract {
  connect(runner?: ContractRunner | null): IGovernorAbi;
  waitForDeployment(): Promise<this>;

  interface: IGovernorAbiInterface;
