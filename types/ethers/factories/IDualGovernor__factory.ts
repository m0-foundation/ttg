...
import type { IDualGovernor, IDualGovernorInterface } from "../IDualGovernor";
...
export class IDualGovernor__factory {
  ...
  static createInterface(): IDualGovernorInterface {
    return new utils.Interface(_abi) as IDualGovernorInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IDualGovernor {
    return new Contract(address, _abi, signerOrProvider) as IDualGovernor;
  }
}
