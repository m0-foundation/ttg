...
export interface EpochBasedVoteTokenInterface extends utils.Interface {
  functions: {
...
export interface EpochBasedVoteToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EpochBasedVoteTokenInterface;
