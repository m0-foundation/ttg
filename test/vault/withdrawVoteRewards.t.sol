...
//     console.log("2. aliceVotes: %s", aliceVotes2);
...
//     console.log("3. aliceVotes: %s", aliceVotes3);
...
//     console.log("alice balance after claim = ", vote.balanceOf(alice));
//     vm.stopPrank();
...
//     console.log("3. bobVotes: %s", bobVotes3);
