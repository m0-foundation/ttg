...
contract PowerTokenTests is TestUtils {
    ...
    function test_getCost() external {
        ...
        assertEq(_powerToken.getCost(totalSupply_), 10_000 * (1 << 99), "1.1");
        assertEq(_powerToken.getCost(onePercentOfTotalSupply_), 100 * (1 << 99), "1.2");
        assertEq(_powerToken.getCost(oneBasisPointOfTotalSupply_), 1 * (1 << 99), "1.3");
        assertEq(_powerToken.getCost(1), uint256(1 * (1 << 99)) / 100_000 + 1, "1.4");

        _jumpSeconds(halfAnAuctionPeriod_);
        assertEq(_powerToken.getCost(totalSupply_), (10_000 * ((1 << 99) + (1 << 98))) / 2, "2.1");
        assertEq(_powerToken.getCost(onePercentOfTotalSupply_), (100 * ((1 << 99) + (1 << 98))) / 2, "2.2");
        assertEq(_powerToken.getCost(oneBasisPointOfTotalSupply_), (1 * ((1 << 99) + (1 << 98))) / 2, "2.3");
        assertEq(_powerToken.getCost(1), uint256(1 * ((1 << 99) + (1 << 98))) / 200_000 + 1, "2.4");

        _jumpSeconds(halfAnAuctionPeriod_);
        assertEq(_powerToken.getCost(totalSupply_), 10_000 * (1 << 98), "3.1");
        assertEq(_powerToken.getCost(onePercentOfTotalSupply_), 100 * (1 << 98), "3.2");
        assertEq(_powerToken.getCost(oneBasisPointOfTotalSupply_), 1 * (1 << 98), "3.3");
        assertEq(_powerToken.getCost(1), uint256(1 * (1 << 98)) / 100_000 + 1, "3.4");

        _jumpSeconds(halfAnAuctionPeriod_);
        assertEq(_powerToken.getCost(totalSupply_), (10_000 * ((1 << 98) + (1 << 97))) / 2, "4.1");
        assertEq(_powerToken.getCost(onePercentOfTotalSupply_), (100 * ((1 << 98) + (1 << 97))) / 2, "4.2");
        assertEq(_powerToken.getCost(oneBasisPointOfTotalSupply_), (1 * ((1 << 98) + (1 << 97))) / 2, "4.3");
        assertEq(_powerToken.getCost(1), uint256(1 * ((1 << 98) + (1 << 97))) / 200_000 + 1, "4.4");

        _jumpSeconds(halfAnAuctionPeriod_);
        assertEq(_powerToken.getCost(totalSupply_), 10_000 * (1 << 97), "5.1");
        assertEq(_powerToken.getCost(onePercentOfTotalSupply_), 100 * (1 << 97), "5.2");
        assertEq(_powerToken.getCost(oneBasisPointOfTotalSupply_), 1 * (1 << 97), "5.3");
        assertEq(_powerToken.getCost(1), uint256(1 * (1 << 97)) / 100_000 + 1, "5.4");

        _jumpSeconds(192 * halfAnAuctionPeriod_);
        assertEq(_powerToken.getCost(totalSupply_), 10_000 * (1 << 1), "6.1");
        assertEq(_powerToken.getCost(onePercentOfTotalSupply_), 100 * (1 << 1), "6.2");
        assertEq(_powerToken.getCost(oneBasisPointOfTotalSupply_), 1 * (1 << 1), "6.3");
        assertEq(_powerToken.getCost(1), 1, "6.4");

        _jumpSeconds(halfAnAuctionPeriod_);
        assertEq(_powerToken.getCost(totalSupply_), (10_000 * ((1 << 1) + (1 << 0))) / 2, "7.1");
        assertEq(_powerToken.getCost(onePercentOfTotalSupply_), (100 * ((1 << 1) + (1 << 0))) / 2, "7.2");
        assertEq(_powerToken.getCost(oneBasisPointOfTotalSupply_), 2, "7.3");
        assertEq(_powerToken.getCost(1), 1, "7.4");

        _jumpSeconds(halfAnAuctionPeriod_);
        assertEq(_powerToken.getCost(totalSupply_), 10_000 * (1 << 0), "8.1");
        assertEq(_powerToken.getCost(onePercentOfTotalSupply_), 100 * (1 << 0), "8.2");
        assertEq(_powerToken.getCost(oneBasisPointOfTotalSupply_), 1 * (1 << 0), "8.3");
        assertEq(_powerToken.getCost(1), 1, "8.4");

        _jumpSeconds(halfAnAuctionPeriod_);
        assertEq(_powerToken.getCost(totalSupply_), 5_000 * (1 << 0), "9.1");
        assertEq(_powerToken.getCost(onePercentOfTotalSupply_), 50 * (1 << 0), "9.2");
        assertEq(_powerToken.getCost(oneBasisPointOfTotalSupply_), 1, "9.3");
        assertEq(_powerToken.getCost(1), 1, "9.4");

        _jumpSeconds(halfAnAuctionPeriod_ / 2);
        assertEq(_powerToken.getCost(totalSupply_), 2_500 * (1 << 0), "10.1");
        assertEq(_powerToken.getCost(onePercentOfTotalSupply_), 25 * (1 << 0), "10.2");
        assertEq(_powerToken.getCost(oneBasisPointOfTotalSupply_), 1, "10.3");
        assertEq(_powerToken.getCost(1), 1, "10.4");

        _jumpSeconds(halfAnAuctionPeriod_ / 4);
        assertEq(_powerToken.getCost(totalSupply_), 1_250 * (1 << 0), "11.1");
        assertEq(_powerToken.getCost(onePercentOfTotalSupply_), 13 * (1 << 0), "11.2");
        assertEq(_powerToken.getCost(oneBasisPointOfTotalSupply_), 1, "11.3");
        assertEq(_powerToken.getCost(1), 1, "11.4");

        _jumpSeconds((halfAnAuctionPeriod_ / 4) - 1);
        assertEq(_powerToken.getCost(totalSupply_), 1, "12.1");
        assertEq(_powerToken.getCost(onePercentOfTotalSupply_), 1, "12.2");
        assertEq(_powerToken.getCost(oneBasisPointOfTotalSupply_), 1, "12.3");
        assertEq(_powerToken.getCost(1), 1, "12.4");
