...
contract StandardGovernorSetProposalFee_IntegrationTest is IntegrationBaseSetup {
    function test_standardGovernorSetProposalFee() external {
        ...
        callDatas_[0] = abi.encodeWithSelector(_standardGovernor.setProposalFee.selector, newProposalFee_);

        string memory description_ = "Set proposal fee";
