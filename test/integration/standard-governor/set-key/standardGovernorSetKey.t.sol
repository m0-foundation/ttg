...
contract StandardGovernorSetKey_IntegrationTest is IntegrationBaseSetup {
    function test_standardGovernorSetKey() external {
        ...
        callDatas_[0] = abi.encodeWithSelector(_standardGovernor.setKey.selector, bytes32("mintDelay"), 0);

        string memory description_ = "Set mintDelay key";
        ...
        vm.expectEmit();
        emit IRegistrar.KeySet("mintDelay", 0);
        ...
        assertEq(_registrar.get("mintDelay"), 0);
    }
}
