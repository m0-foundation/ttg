...
contract StandardGovernorRemoveFromAndAddToList_IntegrationTest is IntegrationBaseSetup {
    function test_standardGovernorRemoveFromAndAddToList() external {
        ...
        string memory description_ = "Remove Dave from MintersList and add Eve";
