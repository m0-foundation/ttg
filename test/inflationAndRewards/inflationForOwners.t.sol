...
contract InflationTest is SPOGBaseTest {
    ...
    // Helper function for testing system invariants
    // _accrueInflation updates the internal _inflation of the delegator
    // _delegate calls _accrueInflation
    // claimInflation 
    function assertBalanceInvariants() public {
    ...
    function test_VotingPowerForDelegatesWithDupedDelegation() public {
        ...
        console2.log("extraTotalVotes", extraTotalVotes/1e18);
        ...
        console2.log("1 -- Carol Vote Balance Before Carol Self Delegation:         ", vote.balanceOf(carol)/1e18);
        ...
        console2.log("1 -- Bob Vote Balance Before Carol Self Delegation:           ", vote.balanceOf(bob)/1e18);
        console2.log("1 -- Bob Voting Power Before Carol Self Delegation:           ", vote.getVotes(bob)/1e18);
