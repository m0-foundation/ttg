...
contract InflationTest is SPOGBaseTest {
    function test_UserVoteInflationAfterVotingOnAllProposals() public {
        ...
        uint256 votesAfterVoting = aliceVotes + (comptroller.inflator() * aliceVotes) / 100;
        ...
        assertEq(inflation, (aliceStartBalance * comptroller.inflator()) / 100, "Alice should have accrued inflation");
    ...
    function test_UsersVoteInflationForMultipleEpochs() public {
        ...
        assertEq(bobVotesAfterFirstVote, (bobStartVotes * (100 + comptroller.inflator())) / 100);
        assertEq(aliceVotesAfterFirstVote, (aliceStartVotes * (100 + comptroller.inflator())) / 100);
        ...
        assertEq(vote.getVotes(alice), (aliceVotesAfterFirstVote * (100 + comptroller.inflator())) / 100);
